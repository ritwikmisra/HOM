...
+(id)service
{
    static DocRegService *master=nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        master=[[DocRegService alloc]initWithService:ADD_DOCTOR];
    });
    return master;
}
...

{
    ...
    {
        //registration_id , name , description ,  email ,  department_id , degree , speciality , phone , doc_image
        // registration_id , name , description ,  email ,  department_id , degree , speciality , phone , doc_image , prefix
        ...
        [dict setObject:strph2 forKey:@"phone"];
